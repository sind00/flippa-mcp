...
export function analyzeListing(listing) {
    ...
    const annualRevenue = monthlyRevenue !== null && monthlyRevenue !== 0
        ? monthlyRevenue * 12
        : null;
    const revenueMultiple = askingPrice !== null &&
        monthlyRevenue !== null &&
        monthlyRevenue !== 0
        ? askingPrice / (monthlyRevenue * 12)
        : null;
    const profitMultiple = askingPrice !== null &&
        monthlyProfit !== null &&
        monthlyProfit !== 0
        ? askingPrice / (monthlyProfit * 12)
        : null;
    const pricePerVisitor = askingPrice !== null && uniques !== null && uniques !== 0
        ? askingPrice / uniques
        : null;
    const estimatedRoiMonths = askingPrice !== null &&
        monthlyProfit !== null &&
        monthlyProfit !== 0
        ? askingPrice / monthlyProfit
        : null;
    const revenuePerVisitor = monthlyRevenue !== null && uniques !== null && uniques !== 0
...
export function registerAnalyzeTool(server) {
    server.registerTool("flippa_analyze_listing", {
...
Examples:
  ...
  - Get analysis as JSON: { "listing_id": "12299903", "response_format": "json" }`,
        ...
        try {
            ...
            const formatted = formatAnalysis(analysis, parsed.response_format);
            return {
