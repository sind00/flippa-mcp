...
export function registerSearchTool(server) {
    server.registerTool("flippa_search_listings", {
...
Examples:
  ...
  - Ending soon auctions: { "sale_method": "auction", "sort_alias": "ending_soonest" }`,
        ...
        try {
            ...
            const hasMore = response.meta.page_number * response.meta.page_size <
            ...
            const formatted = formatSearchResults(result, parsed.response_format);
            return {
