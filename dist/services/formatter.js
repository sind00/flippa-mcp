...
function formatListingDetail(listing) {
    const lines = [];
...
export function formatSearchResults(result, format) {
    if (format === "json") {
...
export function formatListingDetails(listing, format) {
    if (format === "json") {
...
export function formatAnalysis(analysis, format) {
    if (format === "json") {
...
export function formatComparables(result, format) {
    if (format === "json") {
        return truncate(JSON.stringify(result, null, 2));
    }
    const lines = [];
...
export function formatMarketOverview(overview, format) {
    if (format === "json") {
